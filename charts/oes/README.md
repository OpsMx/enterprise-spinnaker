...
`installationMode` | The installation mode. Available installation modes are **OES** (OES including Spinnaker & Autopilot), **AP** (Only Autopilot) and **None**(Skip OES installation) | `OES`
